// src/pages/FileDownloadSpecialist.jsx
import React, { useEffect, useRef } from 'react';
import { useNavigate, useLocation } from 'react-router-dom';

function FileDownloadSpecialist() {
    ...
    useEffect(() => {
        if (!productType || productType !== 'specialist') {
    ...
    useEffect(() => {
        if (productType === 'specialist' && !hasDownloaded.current) {
            hasDownloaded.current = true;
            // Trigger the download
            const downloadLink = document.createElement('a');
            downloadLink.href = '/files/rlBMsm34.tns'; // Update this path to your actual file
            downloadLink.download = 'rlBMsm34.tns';
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="text-center mb-8">
                    <h1 className="text-3xl md:text-4xl font-bold mb-3">
                        Download Black Magic - Specialist
                    </h1>
                ...
                <div className="bg-[#2d5047] rounded-2xl p-8 md:p-12">
                    ...
                    <div className="border-2 border-[#74be9c] rounded-lg p-6 mb-8">
                        ...
                        <ol className="text-gray-300 space-y-3 list-decimal list-inside">
                            ...
                            <li>Click "Select Files" and choose the downloaded rlBMsm34.tns file</li>
...
export default FileDownloadSpecialist;
