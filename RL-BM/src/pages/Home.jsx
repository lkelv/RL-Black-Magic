...
function Home() {
    ...
    return (
        <div className="bg-[#202830] min-h-screen flex flex-col items-center">
            {/* Hero Section */}
            <section className="py-20 px-4 md:px-8 w-full flex items-center justify-center min-h-[80vh] relative overflow-hidden">
                <div className="max-w-5xl w-full flex flex-col items-center text-center relative z-10">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight animate-gradient-shift-continuous px-2" style={{
                        color: '#74be9c',
            ...
            <section
                ...
                className={`py-8 px-4 md:px-8 w-full flex items-center justify-center transition-all duration-1000 ${
                    visibleSections.has('supercharge') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                }`}
            >
                <div className="max-w-5xl w-full flex flex-col items-center">
                    <div className="bg-[#2d5047] rounded-2xl p-6 md:p-12 w-full">
                        <h2 className="text-2xl md:text-4xl font-bold mb-6 text-[#f4a52e] text-center">
            ...
            <section
                ...
                data-section="why"
                className={`py-12 md:py-20 px-6 md:px-8 transition-all duration-1000 ${
                    visibleSections.has('why') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                }`}
            >
                <div className="max-w-6xl mx-auto">
                    <h2 className="text-3xl md:text-5xl font-bold mb-10 md:mb-16 text-center text-white">Why BlackMagic?</h2>
            ...
            <section
                ...
                className={`py-12 md:py-16 px-4 md:px-8 transition-all duration-1000 ${
                    visibleSections.has('coverage') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                }`}
            >
                <div className="max-w-6xl mx-auto">
                    <h2 className="text-3xl md:text-5xl font-bold mb-10 md:mb-12 text-center text-white">Subject Coverage</h2>
                    <div className="bg-[#2d3642] rounded-2xl p-6 md:p-12">
                        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 flex-col-reverse">
                            <div className="text-white space-y-8 flex flex-col justify-center">
                                ...
                                <div className="space-y-6">
                                    <div className="hover:translate-x-2 transition-transform duration-300">
                                        <h3 className="font-bold text-[#74be9c] mb-2 md:mb-3 text-lg">
                                            • Mathematical Methods Units 3 & 4
                                        </h3>
                                        <p className="text-gray-300 text-sm md:text-base leading-relaxed pl-4">
            ...
            <section
                ...
                className={`py-12 md:py-16 px-4 md:px-8 pb-20 md:pb-24 transition-all duration-1000 ${
                    ...
                    <div className="relative flex items-center justify-center gap-2 md:gap-6">
                        ...
                        <div className="bg-[#2d5047] rounded-lg p-6 md:p-12 max-w-3xl min-h-[200px] md:min-h-[250px] flex items-center justify-center flex-1 hover:shadow-2xl transition-shadow duration-300">
                            <p
                                ...
                                className="text-lg md:text-2xl text-center italic text-white leading-relaxed animate-fade-in"
                            >
