            ...
            <section className="py-20 px-8">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    <div className="flex flex-wrap gap-4 justify-center items-center">
                        <a 
                            href="/contact-us" 
                            className="bg-[#f4a52e] hover:bg-[#e09420] text-[#202830] font-bold py-3 px-8 rounded-full transition-colors text-base"
                        >
                            Contact Us
                        </a>
                        <a 
                            href="/activate" 
                            className="bg-[#74be9c] hover:bg-[#62a888] text-[#202830] font-bold py-3 px-8 rounded-full transition-colors text-base"
                        >
                            Activate Now
                        </a>
                    </div>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="flex flex-col lg:flex-row gap-8 items-stretch">
                        ...
                        <div className="w-full lg:w-1/2">
                            <div className="bg-[#2d3642] rounded-xl p-8 h-full flex items-center justify-center min-h-[300px]">
                        ...
                        <div className="w-full lg:w-1/2 text-white flex flex-col justify-center">
                            ...
                            <ul className="space-y-3">
                                <li className="flex items-start gap-3">
                                    <span className="text-[#74be9c] text-xl flex-shrink-0 mt-0.5">✓</span>
                    ...
                    <div className="bg-[#2d3642] rounded-2xl p-8 md:p-12">
                        <div className="flex flex-col lg:flex-row gap-10 items-stretch">
                            ...
                            <div className="w-full lg:w-1/2 text-white">
                                <p className="font-semibold text-lg mb-6">This tool is optimised for:</p>
                                
                                <div className="space-y-6">
                                    <div>
                                        <h3 className="font-bold text-[#74be9c] mb-2 text-base">
                                    ...
                                    <div>
                                        <h3 className="font-bold text-[#74be9c] text-base">
                            ...
                            {/* Image Box */}
                            <div className="w-full lg:w-1/2">
                                <div className="bg-[#202830] rounded-xl p-8 h-full flex items-center justify-center min-h-[300px]">
                                    <div className="text-center text-gray-400">
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex items-center justify-center gap-4">
                        <button 
                            ...
                            className="text-[#f4a52e] text-3xl md:text-4xl hover:text-[#e09420] transition-colors flex-shrink-0 p-2"
                            aria-label="Previous testimonial"
                        >
                            ◀
                        </button>
                        
                        <div className="bg-[#2d5047] rounded-2xl p-8 md:p-12 w-full max-w-4xl min-h-[200px] flex items-center justify-center">
                            <p className="text-lg md:text-xl text-center italic text-white leading-relaxed">
